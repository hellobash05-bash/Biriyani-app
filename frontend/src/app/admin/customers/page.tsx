...
export default function AdminCustomers() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <header>
        <h1 className="text-3xl md:text-4xl font-black text-stone-900 dark:text-gold-100 tracking-tighter uppercase mb-2">Our Community</h1>
        <p className="text-stone-500 dark:text-gold-300/60 font-medium italic text-sm md:text-base">The patrons of the Royale heritage.</p>
      </header>

      {/* Desktop Table View */}
      <div className="hidden md:block premium-card !p-0 overflow-hidden">
        <table className="w-full text-left">
          <thead className="bg-stone-50 dark:bg-white/5 border-b border-stone-200 dark:border-white/10">
            <tr>
          ...
          <tbody>
            {customers.map((customer, i) => (
              <motion.tr 
                ...
                key={customer._id} 
                className="border-b border-stone-100 dark:border-white/5 hover:bg-stone-50/50 dark:hover:bg-white/5 transition-colors"
              >
                <td className="p-6">
                   <div className="flex items-center gap-4">
                     ...
                     <span className="font-bold text-stone-900 dark:text-gold-100">{customer.name}</span>
                   </div>
                </td>
                <td className="p-6">
                   <span className="text-sm font-black text-stone-900 dark:text-orange-500 bg-stone-100 dark:bg-orange-500/5 px-3 py-2 rounded-xl border border-transparent dark:border-orange-500/10">
        ...
        {customers.map((customer, i) => (
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="font-black text-stone-900 dark:text-gold-100 uppercase tracking-tight">{customer.name}</h3>
            ...
            <div className="space-y-4">
              <div className="flex flex-col gap-1">
                ...
                <span className="text-sm font-bold text-stone-900 dark:text-gold-100">{customer.phone || 'N/A'}</span>
              </div>
              <div className="flex flex-col gap-1">
              ...
              <div className="pt-4 border-t border-stone-100 dark:border-white/5 flex justify-between items-center">
                ...
                <span className="text-xs font-bold text-stone-900 dark:text-gold-100">
