      ...
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="w-full max-w-md relative z-10">
        <div className="bg-stone-900/80 backdrop-blur-xl border border-white/10 p-10 rounded-[3rem] shadow-2xl">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-black text-white tracking-tighter uppercase italic">Royale <span className="text-orange-500">Admin</span></h1>
          ...
          <motion.button 
            ...
            disabled={loading} 
            className="w-full flex items-center justify-center gap-4 bg-white/5 border border-white/10 p-5 rounded-2xl font-black uppercase tracking-widest text-[10px] text-stone-200 hover:bg-white/10 transition-all cursor-pointer mb-6"
          >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-[9px] uppercase tracking-[0.2em] font-black"><span className="bg-stone-900 px-4 py-1 rounded-md text-stone-600">Or Email Access</span></div>
          </div>
