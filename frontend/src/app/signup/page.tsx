      ...
      <main className="flex-1 flex items-center justify-center px-6 py-20 relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          <div className="glass rounded-[3rem] p-10 shadow-2xl border border-glass-border relative overflow-hidden">
            ...
            <button onClick={handleGoogleSignup} className="w-full flex items-center justify-center gap-4 bg-background dark:bg-stone-900/50 border border-glass-border p-5 rounded-2xl font-black uppercase tracking-widest text-[10px] text-foreground hover:bg-foreground/5 transition-all cursor-pointer active:scale-[0.98]">
