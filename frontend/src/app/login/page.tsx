          ...
          <div className="premium-card !bg-background/95 rounded-[3.5rem] p-12 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.8)] border border-glass-border relative overflow-hidden backdrop-blur-3xl">
            ...
            <div className="flex flex-col gap-4">
               <button 
                 ...
                 className="w-full flex items-center justify-center gap-4 bg-transparent border border-glass-border p-6 rounded-2xl font-black uppercase tracking-[0.15em] text-xs text-foreground/80 hover:border-orange-500 transition-all cursor-pointer disabled:opacity-50 active:scale-[0.98]"
               >
